class MyFirstHACard extends HTMLElement {
    ...
    static getConfigElement() {
        return document.createElement("my-first-ha-card-editor");
    }
...
class MyFirstHACardEditor extends HTMLElement {
    // private properties
    _config;
    _hass;
    _elements = {};
...
customElements.define("my-first-ha-card-editor", MyFirstHACardEditor);

window.customCards = window.customCards || [];
window.customCards.push({
    type: "my-first-ha-card",
    name: "My First HA Card with graphical configuration (Vanilla JS)",
